...
* unit test 코드: `app/app/tests.py`
  ...
  * 터미널에서 테스트 실행
  ...
  ![image-20210326103247287](images/image-20210326103247287.png)
...
* 터미널에서 테스트 실행: 커맨드 동일. fail!
  ...
  ![image-20210326103746740](images/image-20210326103746740.png)
...
* `app/app/calc.py`: 
  ...
  * add subtract function. 만들었지만, return 값이 `None`이므로 fail
  ...
  ![image-20210326104250843](images/image-20210326104250843.png)
  ...
  * 터미널에서 테스트 실행: OK! new feature successfully added!
  ...
  ![image-20210326104512496](images/image-20210326104512496.png)

* add flake command to tests: run the linting as well

  ![image-20210326104559036](images/image-20210326104559036.png)
  
  <center><sup>flake8 빌드 필요</sup></center>
  
  ![image-20210326104702769](images/image-20210326104702769.png)
  
  <center><sup>linting까지!</sup></center>

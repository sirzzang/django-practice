...
> * :three:에서 email, password 있는 top fields의 의미?
...
![image-20210329165220275](images/image-20210329165220275.png)

<Br>

## :two: User 모델의 admin 페이지 추가
...
![image-20210329165715969](images/image-20210329165715969.png)

<br>

## :three: admin 수정: edit page

* few changes to support custom user model
* the edit page **doesn't** work in *current* state
...
![image-20210329171642354](images/image-20210329171642354.png)
...
![image-20210329172205739](images/image-20210329172205739.png)
...
* test 진행: user add 페이지에 해당하는 field 없으므로 당연히 fail

![image-20210329172658370](images/image-20210329172658370.png)
...
![image-20210329172944710](images/image-20210329172944710.png)
